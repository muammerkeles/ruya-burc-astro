...
function SearchBoxForm() {
    return (
        <form>
            <label for="default-search" class="mb-2 text-sm font-medium text-gray-900 sr-only dark:text-gray-300">örneğin; portakal</label>
            <div class="relative">
                ...
                placeholder="örneğin portakal" required />
